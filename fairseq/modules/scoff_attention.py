...
import numpy as np
import random
from fairseq.modules.scoff_sparse_attn import SparseAttention
import torch.nn.functional as F
from fairseq.modules.scoff_GroupLinearLayer import GroupLinearLayer
from fairseq.modules.scoff_SharedGroupLinearLayer import SharedGroupLinearLayer
...
class MultiHeadAttention(nn.Module):
    ...
    def old_forward(self, q, k, v, mask=None):
        ...
        KLD = -0.5 * torch.sum(1 + q_logvar - q_mu.pow(2) - q_logvar.exp(), dim=1)
