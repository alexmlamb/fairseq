...
from fairseq.modules.scoff_BlockGRU import BlockGRU, SharedBlockGRU
from fairseq.modules.scoff_BlockLSTM import BlockLSTM,SharedBlockLSTM
from fairseq.modules.scoff_attention import MultiHeadAttention
from fairseq.modules.scoff_sparse_grad_attn import blocked_grad
...
class BlocksCore(nn.Module):
    ...
    def __init__(self,
        ...
        self.block_size_in = nhid_in // num_blocks_in
    ...
    def forward(self, inp, hx, cx=None, step=None,do_print=False):
        ...
        if False and self.version:
             ...
             #use attention here.
             #print('inp_use shape init', inp_use.shape, 'block in and size', self.num_blocks_in, self.block_size_in)
             inp_use = inp_use.reshape((inp_use.shape[0], self.num_blocks_in, self.block_size_in))
             inp_use = inp_use.repeat(1,self.num_modules_read_input-1 + 1,1)
